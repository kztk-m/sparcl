...
solveInferredConstraint :: MonadTypeCheck m => [TyConstraint] -> [InferredConstraint] -> m [TyConstraint]
solveInferredConstraint given wanted = do
  ...
  return $ eqRemaining ++ subsRemaining
